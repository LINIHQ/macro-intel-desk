...
export const metadata = {
  title: 'Methodology | GenXKrypto Macro Intelligence Desk',
};
  ...
  return (
    <div>
      ...
      <p className="page-sub">
        How this desk works, published up front so every brief can be checked against it. This is an intelligence
        product, not a confirmation-bias engine, and not investment advice.
      </p>
